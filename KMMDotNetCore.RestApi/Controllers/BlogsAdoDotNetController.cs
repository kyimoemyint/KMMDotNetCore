...
using KMMDotNetCore.RestApi.ViewModels;
...
namespace KMMDotNetCore.RestApi.Controllers
{
    ...
    {
        private readonly string _connectionString = "Data Source=.;Initial Catalog=DotNetTrainingBatch5;User ID=sa;Password=kmm@123;TrustServerCertificate=true;";
        ...
        public IActionResult PatchBlog(int id, BlogViewModel blog)
        {
            ...
            string value = result == 1 ? "Updating Successful." : "Updating Failed";
